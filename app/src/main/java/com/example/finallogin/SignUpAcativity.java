...
public class SignUpAcativity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_sign_up_acativity);
    ...
    {
        startActivity(new Intent(SignUpAcativity.this,LoginActivity.class));
    }
